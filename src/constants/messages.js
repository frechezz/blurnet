...
Ваш платеж был успешно отправлен на проверку ✓
Администратор скоро проверит вашу квитанцию ⌛️

Обычно это занимает до 5-10 минут, но в редких случаях может потребоваться до часа.
`,

    send_receipt: `
❗️Пожалуйста, пришлите квитанцию об оплате или скриншот перевода❗️

Это позволит нам быстрее проверить вашу оплату и активировать доступ к сервису.
`,

    success: `
<b>🎉 Платеж успешно подтвержден!</b> ✔️

Поздравляем! Вы получили доступ к ${SERVICE_NAME}. 

Переходите по ссылке ниже и следуйте инструкции по подключению:
`,
...
<u>Пожалуйста, проверьте:</u>
1. Корректность введенных реквизитов
2. Правильность суммы платежа
3. Что платеж действительно был проведен

После этого попробуйте произвести оплату снова или свяжитесь с нами.
